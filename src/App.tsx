  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-pink-100 via-blue-100 to-emerald-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-700 transition-colors duration-500">
        <ThemeToggle />
        <div className="flex flex-col items-center gap-2 mt-12 mb-8 animate-fade-in md:ml-40 ml-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl px-4 pb-16 md:ml-40 ml-0">
        ...
        <footer className="text-zinc-400 dark:text-zinc-500 text-xs mt-8 mb-2 text-center w-full md:ml-40 ml-0">
